...
/*bool MainScene::isWallAtTileCoord(const Point &tileCoord) const
{
	return this->isPropAtTileCoordForLayer("Wall", tileCoord, _background);
}

Point MainScene::tileCoordForPosition(const Point &position) const
{
...
Point MainScene::positionForTileCoord(const Point &tileCoord) const
{
...
bool MainScene::isPropAtTileCoordForLayer(const char *prop, const Point &tileCoord, TMXLayer *layer) const
{
...
bool MainScene::isValidTileCoord(const Point &tileCoord) const
{
...
PointArray *MainScene::walkableAdjacentTilesCoordForTileCoord(const Point &tileCoord) const
{
